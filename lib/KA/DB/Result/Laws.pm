...
__PACKAGE__->typecast_map(type => {
    BHGNeutralized          => 'KA::DB::Result::Laws::BHGNeutralized',
    BHGPassport             => 'KA::DB::Result::Laws::BHGPassport',
    MembersOnlyColonization => 'KA::DB::Result::Laws::MembersOnlyColonization',
    MembersOnlyStations     => 'KA::DB::Result::Laws::MembersOnlyStations',
    MembersOnlyMiningRights => 'KA::DB::Result::Laws::MembersOnlyMiningRights',
    MembersOnlyExcavation   => 'KA::DB::Result::Laws::MembersOnlyExcavation',
    Taxation                => 'KA::DB::Result::Laws::Taxation',
    Writ                    => 'KA::DB::Result::Laws::Writ',
});
