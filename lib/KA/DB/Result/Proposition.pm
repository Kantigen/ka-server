package KA::DB::Result::Proposition;
...
__PACKAGE__->typecast_map(type => {
    AbandonStation          => 'KA::DB::Result::Proposition::AbandonStation',
    BHGNeutralized          => 'KA::DB::Result::Proposition::BHGNeutralized',
    BHGPassport             => 'KA::DB::Result::Proposition::BHGPassport',
    BroadcastOnNetwork19    => 'KA::DB::Result::Proposition::BroadcastOnNetwork19',
    DemolishModule          => 'KA::DB::Result::Proposition::DemolishModule',
    DowngradeModule         => 'KA::DB::Result::Proposition::DowngradeModule',
    EnactWrit               => 'KA::DB::Result::Proposition::EnactWrit',
    ElectNewLeader          => 'KA::DB::Result::Proposition::ElectNewLeader',
    EvictExcavator          => 'KA::DB::Result::Proposition::EvictExcavator',
    EvictMiningPlatform     => 'KA::DB::Result::Proposition::EvictMiningPlatform',
    ExpelMember             => 'KA::DB::Result::Proposition::ExpelMember',
    FireBfg                 => 'KA::DB::Result::Proposition::FireBfg',
    ForeignAid              => 'KA::DB::Result::Proposition::ForeignAid',
    InductMember            => 'KA::DB::Result::Proposition::InductMember',
    InstallModule           => 'KA::DB::Result::Proposition::InstallModule',
    MembersOnlyColonization => 'KA::DB::Result::Proposition::MembersOnlyColonization',
    MembersOnlyStations     => 'KA::DB::Result::Proposition::MembersOnlyStations',
    MembersOnlyExcavation   => 'KA::DB::Result::Proposition::MembersOnlyExcavation',
    MembersOnlyMiningRights => 'KA::DB::Result::Proposition::MembersOnlyMiningRights',
    RenameAsteroid          => 'KA::DB::Result::Proposition::RenameAsteroid',
    RenameStar              => 'KA::DB::Result::Proposition::RenameStar',
    RenameStation           => 'KA::DB::Result::Proposition::RenameStation',
    RenameUninhabited       => 'KA::DB::Result::Proposition::RenameUninhabited',
    RepairModule            => 'KA::DB::Result::Proposition::RepairModule',
    RepealLaw               => 'KA::DB::Result::Proposition::RepealLaw',
    Taxation                => 'KA::DB::Result::Proposition::Taxation',
    TransferStationOwnership=> 'KA::DB::Result::Proposition::TransferStationOwnership',
    UpgradeModule           => 'KA::DB::Result::Proposition::UpgradeModule',
});
...
__PACKAGE__->has_many('votes', 'KA::DB::Result::Vote', 'proposition_id');
