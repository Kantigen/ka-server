package KA::DB::Result::Fleet::GasGiantSettlementPlatformShip;
...
use constant prereq                 => [ { class=> 'KA::DB::Result::Building::GasGiantLab',  level => 1 } ];
...
with "KA::Role::Fleet::Send::GasGiant";
with "KA::Role::Fleet::Arrive::AddGasGiantPlatform";
