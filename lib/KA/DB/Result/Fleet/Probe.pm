package KA::DB::Result::Fleet::Probe;
...
use constant prereq                 => [{ class=> 'KA::DB::Result::Building::Observatory',  level => 1 }];
...
with "KA::Role::Fleet::Send::Star";
with "KA::Role::Fleet::Arrive::DeployProbe";
