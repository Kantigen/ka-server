package KA::DB::Result::Fleet::MiningPlatformShip;
...
use constant prereq                 => [ { class=> 'KA::DB::Result::Building::Ore::Ministry',  level => 1 }];
...
with "KA::Role::Fleet::Send::Asteroid";
with "KA::Role::Fleet::Arrive::TriggerDefense";
with "KA::Role::Fleet::Arrive::DeployMiningPlatform";
