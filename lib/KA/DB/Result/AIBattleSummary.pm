package KA::DB::Result::AIBattleSummary;
...
__PACKAGE__->belongs_to('empire', 'KA::DB::Result::Empire', 'attacking_empire_id');
__PACKAGE__->belongs_to('empire', 'KA::DB::Result::Empire', 'defending_empire_id');
