package KA::DB::Result::Building::SSLa;
...
use constant controller_class => 'KA::RPC::Building::SSLa';
...
before 'can_demolish' => sub {
    my $self = shift;
    my $sslb = $self->body->get_building_of_class('KA::DB::Result::Building::SSLb');
    if (defined $sslb) {
...
sub makeable_plans {
    return {
        command         => 'KA::DB::Result::Building::Module::StationCommand',
        ibs             => 'KA::DB::Result::Building::Module::IBS',
        art             => 'KA::DB::Result::Building::Module::ArtMuseum',
        opera           => 'KA::DB::Result::Building::Module::OperaHouse',
        food            => 'KA::DB::Result::Building::Module::CulinaryInstitute',
        parliament      => 'KA::DB::Result::Building::Module::Parliament',
        warehouse       => 'KA::DB::Result::Building::Module::Warehouse',
        policestation   => 'KA::DB::Result::Building::Module::PoliceStation',
    };
}
...
has max_level => (
    ...
    default => sub {
        ...
        foreach my $part (qw(b c d)) {
            my $building = $body->get_building_of_class('KA::DB::Result::Building::SSL'.$part);
            if (defined $building) {
