package KA::DB::Result::Building::Stockpile;

use Moose;
use utf8;
no warnings qw(uninitialized);
extends 'KA::DB::Result::Building';
use KA::Constants qw(GROWTH_F INFLATION_F CONSUME_N WASTE_F WASTE_N TINFLATE_F);
...
use constant controller_class => 'KA::RPC::Building::Stockpile';
...
#           $building->isa('KA::DB::Result::Building::Waste::Exchanger'))) {
