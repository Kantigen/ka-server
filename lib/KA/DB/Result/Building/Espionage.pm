package KA::DB::Result::Building::Espionage;
...
use constant controller_class => 'KA::RPC::Building::Espionage';

use constant max_instances_per_planet => 1;

use constant building_prereq => {'KA::DB::Result::Building::Intelligence'=>1};
