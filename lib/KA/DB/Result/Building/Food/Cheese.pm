package KA::DB::Result::Building::Food::Cheese;
...
use constant controller_class => 'KA::RPC::Building::Cheese';

use constant image => 'cheese';

use constant building_prereq => {'KA::DB::Result::Building::Food::Dairy'=>5};
