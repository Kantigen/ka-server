package KA::DB::Result::Building::Food::Syrup;
...
use constant controller_class => 'KA::RPC::Building::Syrup';

use constant image => 'syrup';

use constant building_prereq => {'KA::DB::Result::Building::Food::Algae'=>5};
