package KA::DB::Result::Building::Food::Shake;
...
use constant controller_class => 'KA::RPC::Building::Shake';

use constant building_prereq => {'KA::DB::Result::Building::Food::Beeldeban'=>5};
