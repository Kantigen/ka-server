package KA::DB::Result::Building::Food::Beeldeban;

use Moose;
use utf8;
no warnings qw(uninitialized);
extends 'KA::DB::Result::Building::Food';
use KA::Constants qw(GROWTH_F INFLATION_N CONSUME_S);

use constant controller_class => 'KA::RPC::Building::Beeldeban';

use constant building_prereq => {'KA::DB::Result::Building::Food::Root'=>5};
