package KA::DB::Result::Building::Food::Pancake;
...
use constant controller_class => 'KA::RPC::Building::Pancake';

use constant building_prereq => {'KA::DB::Result::Building::Food::Potato'=>5};
