package KA::DB::Result::Building::Food::Bread;
...
use constant controller_class => 'KA::RPC::Building::Bread';

use constant building_prereq => {'KA::DB::Result::Building::Food::Wheat'=>5};
