package KA::DB::Result::Building::Food::Soup;
...
use constant controller_class => 'KA::RPC::Building::Soup';

use constant image => 'cannery';

use constant building_prereq => {'KA::DB::Result::Building::Food::Bean'=>5};
