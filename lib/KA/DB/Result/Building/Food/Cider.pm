package KA::DB::Result::Building::Food::Cider;
...
use constant controller_class => 'KA::RPC::Building::Cider';

use constant image => 'cider';

use constant building_prereq => {'KA::DB::Result::Building::Food::Apple'=>5};
