package KA::DB::Result::Building::Food::Pie;
...
use constant controller_class => 'KA::RPC::Building::Pie';

use constant image => 'pie';

use constant building_prereq => {'KA::DB::Result::Building::Food::Lapis'=>5};
