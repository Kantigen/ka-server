package KA::DB::Result::Building::Food::Burger;
...
use constant controller_class => 'KA::RPC::Building::Burger';

use constant image => 'burger';

use constant building_prereq => {'KA::DB::Result::Building::Food::Malcud'=>5};
