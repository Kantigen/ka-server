package KA::DB::Result::Building::Intelligence;
...
use constant controller_class => 'KA::RPC::Building::Intelligence';
...
has espionage_level => (
    ...
    default => sub {
        my $self = shift;
        my $building = $self->body->get_building_of_class('KA::DB::Result::Building::Espionage');
...
has security_level => (
    ...
    default => sub {
        my $self = shift;
        my $building = $self->body->get_building_of_class('KA::DB::Result::Building::Security');   
        return (defined $building) ? $building->effective_level : 0;
    },
);
