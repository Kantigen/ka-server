package KA::DB::Result::Building::Transporter;
...
use constant controller_class => 'KA::RPC::Building::Transporter';
...
sub push_items {
    ...
    my $container = KA::VirtualContainer->new(payload => $payload);
