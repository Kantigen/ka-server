package KA::DB::Result::Building::SSLc;
...
# use constant building_prereq => {'KA::DB::Result::Building::SSLb'=>1};
use constant max_instances_per_planet => 1;

use constant controller_class => 'KA::RPC::Building::SSLc';
...
before 'can_demolish' => sub {
    my $self = shift;
    my $ssld = $self->body->get_building_of_class('KA::DB::Result::Building::SSLd');
    if (defined $ssld) {
