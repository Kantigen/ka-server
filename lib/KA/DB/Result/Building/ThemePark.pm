package KA::DB::Result::Building::ThemePark;
...
use DateTime;
use KA::Constants qw(FOOD_TYPES GROWTH_F INFLATION_F CONSUME_F WASTE_F HAPPY_F TINFLATE_F);
...
use constant controller_class => 'KA::RPC::Building::ThemePark';
