package KA::DB::Result::Building::LuxuryHousing;

use Moose;
use utf8;
no warnings qw(uninitialized);
extends 'KA::DB::Result::Building';
use KA::Constants qw(INFLATION_F CONSUME_F WASTE_F HAPPY_F TINFLATE_F);
...
use constant controller_class => 'KA::RPC::Building::LuxuryHousing';
