package KA::DB::Result::Building::Energy::Singularity;

use Moose;
use utf8;
no warnings qw(uninitialized);
extends 'KA::DB::Result::Building::Energy';

use KA::Constants qw(GROWTH_F INFLATION_F CONSUME_N WASTE_S WASTE_N);
...
use constant controller_class => 'KA::RPC::Building::Singularity';
