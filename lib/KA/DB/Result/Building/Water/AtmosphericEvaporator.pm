package KA::DB::Result::Building::Water::AtmosphericEvaporator;

use Moose;
use utf8;
no warnings qw(uninitialized);
use KA::Constants qw(GROWTH_F INFLATION_N CONSUME_S);
extends 'KA::DB::Result::Building::Water';

use constant controller_class => 'KA::RPC::Building::AtmosphericEvaporator';
