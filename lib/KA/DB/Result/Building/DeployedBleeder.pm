package KA::DB::Result::Building::DeployedBleeder;
...
use KA::Constants qw(FOOD_TYPES ORE_TYPES GROWTH INFLATION);

with 'KA::Role::Building::IgnoresUniversityLevel';

use constant controller_class => 'KA::RPC::Building::DeployedBleeder';
    ...
    if ($self->level >= 30) {
        ...
        if ($@) {
            my ($building) = shuffle grep {
                    ...
                    ($_->class ne 'KA::DB::Result::Building::Module::Parliament')
            }
