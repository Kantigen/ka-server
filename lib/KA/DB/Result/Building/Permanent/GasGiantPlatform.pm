package KA::DB::Result::Building::Permanent::GasGiantPlatform;
...
use constant controller_class => 'KA::RPC::Building::GasGiantPlatform';
...
before 'can_demolish' => sub {
  ...
  my $gg_plots = 0;
  my $gg_cnt = 0;
  my @buildings = grep {$_->class eq 'KA::DB::Result::Building::Permanent::GasGiantPlatform'} @{$body->building_cache};
