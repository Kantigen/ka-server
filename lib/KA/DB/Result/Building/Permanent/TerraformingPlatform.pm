package KA::DB::Result::Building::Permanent::TerraformingPlatform;

use Moose;
use utf8;
no warnings qw(uninitialized);
use KA::Constants qw(GROWTH_F INFLATION_F CONSUME_F WASTE_F);
...
use constant controller_class => 'KA::RPC::Building::TerraformingPlatform';
...
before 'can_demolish' => sub {
  ...
  my @buildings = grep {$_->class eq 'KA::DB::Result::Building::Permanent::TerraformingPlatform'} @{$body->building_cache};
