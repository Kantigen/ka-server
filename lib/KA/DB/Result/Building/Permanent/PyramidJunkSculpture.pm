package KA::DB::Result::Building::Permanent::PyramidJunkSculpture;
...
use constant controller_class => 'KA::RPC::Building::PyramidJunkSculpture';

use KA::Constants qw(INFLATION_F WASTE_F HAPPY_F TINFLATE_F);
