package KA::DB::Result::Building::Ore::Refinery;
...
use constant controller_class => 'KA::RPC::Building::OreRefinery';

use constant building_prereq => {'KA::DB::Result::Building::Ore::Mine' => 5};
