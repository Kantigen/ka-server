...
__PACKAGE__->typecast_map(type => {
    'attack_group'                          => 'KA::DB::Result::Ships::AttackGroup', #attack ships combined into one group.
    'probe'                                 => 'KA::DB::Result::Ships::Probe',
    'stake'                                 => 'KA::DB::Result::Ships::Stake',
    'supply_pod'                            => 'KA::DB::Result::Ships::SupplyPod',
    'supply_pod2'                           => 'KA::DB::Result::Ships::SupplyPod2',
    'supply_pod3'                           => 'KA::DB::Result::Ships::SupplyPod3',
    'supply_pod4'                           => 'KA::DB::Result::Ships::SupplyPod4',
    'supply_pod5'                           => 'KA::DB::Result::Ships::SupplyPod5',
    'placebo'                               => 'KA::DB::Result::Ships::Placebo',
    'placebo2'                              => 'KA::DB::Result::Ships::Placebo2',
    'placebo3'                              => 'KA::DB::Result::Ships::Placebo3',
    'placebo4'                              => 'KA::DB::Result::Ships::Placebo4',
    'placebo5'                              => 'KA::DB::Result::Ships::Placebo5',
    'placebo6'                              => 'KA::DB::Result::Ships::Placebo6',
    'short_range_colony_ship'               => 'KA::DB::Result::Ships::ShortRangeColonyShip',
    'colony_ship'                           => 'KA::DB::Result::Ships::ColonyShip',
    'spy_pod'                               => 'KA::DB::Result::Ships::SpyPod',
    'cargo_ship'                            => 'KA::DB::Result::Ships::CargoShip',
    'space_station'                         => 'KA::DB::Result::Ships::SpaceStation',
    'smuggler_ship'                         => 'KA::DB::Result::Ships::SmugglerShip',
    'mining_platform_ship'                  => 'KA::DB::Result::Ships::MiningPlatformShip',
    'terraforming_platform_ship'            => 'KA::DB::Result::Ships::TerraformingPlatformShip',
    'gas_giant_settlement_ship'             => 'KA::DB::Result::Ships::GasGiantSettlementPlatformShip',
    'scanner'                               => 'KA::DB::Result::Ships::Scanner',
    'surveyor'                              => 'KA::DB::Result::Ships::Surveyor',
    'detonator'                             => 'KA::DB::Result::Ships::Detonator',
    'excavator'                             => 'KA::DB::Result::Ships::Excavator',
    'scow'                                  => 'KA::DB::Result::Ships::Scow',
    'scow_large'                            => 'KA::DB::Result::Ships::ScowLarge',
    'scow_mega'                             => 'KA::DB::Result::Ships::ScowMega',
    'scow_fast'                             => 'KA::DB::Result::Ships::ScowFast',
    'freighter'                             => 'KA::DB::Result::Ships::Freighter',
    'dory'                                  => 'KA::DB::Result::Ships::Dory',
    'barge'                                 => 'KA::DB::Result::Ships::Barge',
    'galleon'                               => 'KA::DB::Result::Ships::Galleon',
    'hulk'                                  => 'KA::DB::Result::Ships::Hulk',
    'hulk_huge'                             => 'KA::DB::Result::Ships::HulkHuge',
    'hulk_fast'                             => 'KA::DB::Result::Ships::HulkFast',
    'snark'                                 => 'KA::DB::Result::Ships::Snark',
    'snark2'                                => 'KA::DB::Result::Ships::Snark2',
    'snark3'                                => 'KA::DB::Result::Ships::Snark3',
    'spy_shuttle'                           => 'KA::DB::Result::Ships::SpyShuttle',
    'drone'                                 => 'KA::DB::Result::Ships::Drone',
    'fighter'                               => 'KA::DB::Result::Ships::Fighter',
    'sweeper'                               => 'KA::DB::Result::Ships::Sweeper',
    'bleeder'                               => 'KA::DB::Result::Ships::Bleeder',
    'thud'                                  => 'KA::DB::Result::Ships::Thud',
    'observatory_seeker'                    => 'KA::DB::Result::Ships::ObservatorySeeker',
    'spaceport_seeker'                      => 'KA::DB::Result::Ships::SpacePortSeeker',
    'security_ministry_seeker'              => 'KA::DB::Result::Ships::SecurityMinistrySeeker',
    'fissure_sealer'                        => 'KA::DB::Result::Ships::FissureSealer',
});
...
sub send {
    ...
    my $ships_rs;
    my $ag_chk = 0;
    if ($options{target}->isa('KA::DB::Result::Map::Star')) {
        $ag_chk = 0; #Just an empty statement.
    }
    elsif ( grep { $self->type eq $_ } @ag_list ) {
        $ships_rs = KA->db->resultset('KA::DB::Result::Ships')->search({
            id      => { '!=' => $self->id },
...
sub reschedule_queue {
    ...
    my @ships_queue = KA->db->resultset('Ships')->search({
        task        => 'Building',
