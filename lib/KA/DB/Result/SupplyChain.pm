package KA::DB::Result::SupplyChain;
...
__PACKAGE__->belongs_to('target', 'KA::DB::Result::Map::Body', 'target_id');
__PACKAGE__->belongs_to('building', 'KA::DB::Result::Building', 'building_id');
__PACKAGE__->belongs_to('planet', 'KA::DB::Result::Map::Body', 'planet_id');
