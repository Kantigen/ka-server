package KA::Role::Fleet::Arrive::DamageBuilding;
...
after handle_arrival_procedures => sub {
    ...
    my ($citadel) = grep {$_->class eq 'KA::DB::Result::Building::Permanent::CitadelOfKnope'} @{$body_attacked->building_cache};
    if (defined $citadel) {
        $building = $citadel;
    }
    ...
    if (not defined $building) {
        ($building) =
            ...
            grep {
                ...
                ($_->class ne 'KA::DB::Result::Building::TheDillonForge')
