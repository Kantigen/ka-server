package KA::Role::Fleet::Arrive::DeployExcavator;
...
after can_send_to_target => sub {
    ...
    confess [1009, 'Can only be sent to asteroids and habitable planets.'] if ($target->isa('KA::DB::Result::Map::Body::Planet::GasGiant'));
