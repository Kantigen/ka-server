package KA::RPC::Building::MercenariesGuild;
...
sub model_class {
    return 'KA::DB::Result::Building::MercenariesGuild';
}
...
sub accept_from_market {
    ...
    my $int_min = $building->body->get_building_of_class('KA::DB::Result::Building::Intelligence');
