...
sub colony_structures {
    ...
    ['KA::DB::Result::Building::Development', 5],
    ['KA::DB::Result::Building::Intelligence', 30],
    ['KA::DB::Result::Building::Security', 30],
    ['KA::DB::Result::Building::Espionage', 30],
    ['KA::DB::Result::Building::Permanent::CitadelOfKnope',30],
    ['KA::DB::Result::Building::Shipyard',30],
    ['KA::DB::Result::Building::Shipyard',30],
    ['KA::DB::Result::Building::Shipyard',30],
    ['KA::DB::Result::Building::Shipyard',30],
    ['KA::DB::Result::Building::Shipyard',30],
    ...
    ['KA::DB::Result::Building::Propulsion', 25],
    ['KA::DB::Result::Building::Trade', 20],
    ['KA::DB::Result::Building::Observatory', 10],
    ['KA::DB::Result::Building::Permanent::CrashedShipSite',25],
    ...
    ['KA::DB::Result::Building::Permanent::GratchsGauntlet',20],
    ['KA::DB::Result::Building::Permanent::GeoThermalVent',30],
    ['KA::DB::Result::Building::Permanent::KalavianRuins',25],
    ...
    ['KA::DB::Result::Building::Permanent::OracleOfAnid',15],
    );
}
...
sub destroy_world {
    ...
    my $targets = KA->db->resultset('Map::Body')->search({
            "me.zone"   => $colony->zone,
            size        => { between => [46, 75] },
            empire_id   => undef,
    ...
    my $targetidx  = KA::Util::randint(0,$numtargets - 1);
