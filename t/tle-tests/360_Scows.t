...
my $scow2 = KA->db->resultset('KA::DB::Result::Ships')->new({type=>'scow'});
$shipyard->build_ship($scow2);

my $scow3 = KA->db->resultset('KA::DB::Result::Ships')->new({type=>'scow'});
$shipyard->build_ship($scow);
...
$scow = KA->db->resultset('KA::DB::Result::Ships')->search({id=>$scow->id})->first; # pull the latest data on this ship
...
$scow2 = KA->db->resultset('KA::DB::Result::Ships')->search({id=>$scow2->id})->first; # pull the latest data on this ship
...
my $scow4 = KA->db->resultset('KA::DB::Result::Ships')->new({type=>'scow'});
...
$scow3 = KA->db->resultset('KA::DB::Result::Ships')->search({id=>$scow3->id})->first; # pull the latest data on this ship
$scow4 = KA->db->resultset('KA::DB::Result::Ships')->search({id=>$scow4->id})->first; # pull the latest data on this ship
